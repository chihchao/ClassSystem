...
<HTML>
<HEAD>
<TITLE><? echo($homepage_title); ?> → 相片區 → 新增相片</TITLE>
</HEAD>
...
<TR>
	<TD width="100%"><font color="#FFFFFF">新 . 增 . 相 . 片</font></TD>
	<TD>
...
<FORM METHOD="POST" enctype="multipart/form-data" ACTION="PhotoDocumentAddDB.php">
...
<TR>
	...
	<TD valign="top" width="100%">在 『<? echo($folder_name); ?>』 下新增相片。</TD>
</TR>
</TABLE>
...
<TR>
	<TD valign="top"><IMG SRC="Images/PublicPointer.gif" BORDER=0></TD>
	<TD valign="top">相片標題：</TD>
	<TD><INPUT TYPE="text" NAME="document_title" size="40"></TD>
</TR>
<TR>
	<TD valign="top"><IMG SRC="Images/PublicPointer.gif" BORDER=0></TD>
	<TD valign="top">相片說明：</TD>
	<TD><TEXTAREA NAME="document_content" ROWS="8" COLS="40"></TEXTAREA></TD>
</TR>
<TR>
	<TD valign="top"><IMG SRC="Images/PublicPointer.gif" BORDER=0></TD>
