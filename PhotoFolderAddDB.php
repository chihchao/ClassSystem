...
$str = "insert into photo_folder (teacher_id, up_folder_id, folder_name, folder_explain, folder_time) Values ('" . func_escape_string($teacher_id) . "', '" . func_escape_string($folder_id) . "', '" . func_escape_string($folder_name) . "', '" . func_escape_string($folder_explain) . "', now())";
QueryDatabase($str);
