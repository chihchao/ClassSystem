...
if ($up_folder_id != 0){
	$str = "Select folder_id From document_folder Where teacher_id = '" . func_escape_string($teacher_id) . "' And folder_id = '" . func_escape_string($up_folder_id) . "'";
...
$str = "Update document_folder Set up_folder_id = '" . func_escape_string($up_folder_id) . "' Where teacher_id = '" . $teacher_id . "' And folder_id = '" . $folder_id . "'";
QueryDatabase($str);
